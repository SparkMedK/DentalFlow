...
export default function DashboardPage() {
  ...
  return (
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
      ...
      <Card className="mt-6">
        <CardHeader>
          <CardTitle>Welcome to Cabinoxel</CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-muted-foreground">
            This is your central hub for managing patients and consultations. Use the navigation on the left to get started. You can view your patient directory, schedule new consultations.
          </p>
        </CardContent>
      </Card>
    </div>
